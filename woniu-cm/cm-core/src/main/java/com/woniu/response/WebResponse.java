...
public class WebResponse<T> implements Serializable {
     ...
     * @return
     **/
    public WebResponse(IResponseCode responseCode, T result) {
     ...
     * @return
     **/
    public WebResponse(String prefix, IResponseCode responseCode) {
        this.code = responseCode.getCode();
     ...
     * @return
     **/
    public WebResponse(IResponseCode responseCode) {
        this.code = responseCode.getCode();
        this.message = responseCode.getMessage();
        this.isSuccess = successOrfail();
    }
